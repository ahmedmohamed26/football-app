							...
							{!loadSpinner ? (
								<Fragment>
									<div className='details-match'>
										<h2> next match </h2>
										{nextMatch != null ? 	<div className='date-match'>
											<h4 className='text-center'>
												{`${
													new Date(nextMatch?.dateEvent).getMonth() + 1
												} / ${new Date(nextMatch?.dateEvent).getDate()}`}
											</h4>
											...
											<h5 className='text-center'>
												{' '}
												{nextMatch?.strFilename}{' '}
											</h5>
										</div> : <div className='date-match'>
										 <h4 className='text-center'>
										 - / -
											</h4>
											</div> }
									...
									<div className='details-match'>
										...
										<div className='date-match'>
											<h4 className='text-center'>
												{`${
													new Date(lastMatch?.dateEvent).getMonth() + 1
												} / ${new Date(lastMatch?.dateEvent).getDate()}`}
											</h4>
											<div className='d-flex justify-content-around align-items-center'>
												<div className='away-team text-center'>
													<img src={team?.strTeamBadge} alt={team?.strTeam} />
